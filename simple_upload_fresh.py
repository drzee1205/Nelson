...
Since deletion is complex, this script focuses on uploading the fresh data.
You can manually clear the table via Supabase dashboard first, then run this.
"""
...
class SimpleUploader:
    """Simple uploader for fresh CSV data"""
...
def main():
    ...
    print("📤 NELSON PEDIATRICS SIMPLE CSV UPLOAD")
    print("=" * 60)
    print("🎯 Upload fresh CSV data to Supabase")
    print("📋 Table: nelson_textbook_chunks")
    print("📄 Source: nelson_textbook_chunks.csv")
    print("=" * 60)
    
    print("\n💡 RECOMMENDATION:")
    print("   If you have existing data, clear it first via:")
    print("   1. Supabase Dashboard → SQL Editor")
    print("   2. Run: TRUNCATE TABLE nelson_textbook_chunks;")
    print("   3. Then run this script")
    
    response = input("\n❓ Ready to upload? Type 'UPLOAD' to proceed: ").strip()
    ...
    # Initialize uploader
    uploader = SimpleUploader(batch_size=50)
